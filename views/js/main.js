...
var resizePizzas = function(size) {
  ...
  function changeSliderLabel(size) {
    var slideLabel = document.querySelector("#pizzaSize");
    switch(size) {
      case "1":
        slideLabel.innerHTML = "Small";
        return;
      case "2":
        slideLabel.innerHTML = "Medium";
        return;
      case "3":
        slideLabel.innerHTML = "Large";
        return;
      default:
  ...
  function changePizzaSizes(size) {
    ...
    switch(size) {
      ...
      case "3":
        ...
        break;
      default:
        console.log("Unexpected pizza size");
    }
